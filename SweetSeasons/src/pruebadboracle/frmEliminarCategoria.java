...
public class frmEliminarCategoria extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if (jTextField1.getText().isEmpty() ) {
                ...
                int idCategoria = Integer.parseInt(jTextField1.getText());
            
                String mensaje = cbo.eliminarCategoria(idCategoria);
            ...
            Logger.getLogger(frmEliminarCategoria.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmEliminarCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmEliminarCategoria().setVisible(true);
            }
        });
    }
